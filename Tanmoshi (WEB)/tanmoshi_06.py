...
# 04
replace_scenes: List[Tuple[int, int]] = [(672, 2924), (31911, 34215), ]


# WAKANIM dehardsubbed with Funimation, audio trimmed and taken from Amazon
WEB_FU = FileInfo("Episodes/Funimation/[SubsPlease] Tantei wa Mou, Shindeiru. - 06 (1080p) [E8753A0D].mkv", (168, None), preset=[PresetWEB, PresetEAC3])
WEB_WK = FileInfo("Episodes/Wakanim/The Detective Is Already Dead E06 [1080p][E-AC3][JapDub][GerSub][Web-DL].mkv", preset=[PresetWEB, PresetEAC3])
# WEB_BL = FileInfo("Episodes/B-global/[NC-Raws] 侦探已死 / Tantei wa Mou, Shindeiru. - 06 [B-Global][WEB-DL][1080p][AVC AAC][CHS_CHT_ENG_TH_SRT][MKV].mkv", (1, None), preset=[PresetWEB, PresetEAC3])
WEB_AMZ = FileInfo('Episodes/Amazon/Tantei wa Mou, Shindeiru. - 06 (Amazon dAnime CBR 720p).mkv', (None, -1), preset=[PresetWEB, PresetEAC3])
