...
# 04
replace_scenes: List[Tuple[int, int]] = [(4029, 6387), (31769, 34046), ]


# WAKANIM dehardsubbed with Funimation, audio trimmed and taken from Amazon
WEB_FU = FileInfo("Episodes/Funimation/[SubsPlease] Tantei wa Mou, Shindeiru. - 05 (1080p) [F3407819].mkv", (240, None), preset=[PresetWEB, PresetEAC3])
WEB_WK = FileInfo("Episodes/Wakanim/The Detective Is Already Dead E05 [1080p][E-AC3][JapDub][GerSub][Web-DL].mkv", preset=[PresetWEB, PresetEAC3])
WEB_BL = FileInfo("Episodes/B-global/[NC-Raws] 侦探已死 - 05 [B-Global][WEB-DL][1080p][AVC AAC][ENG_TH_SRT][MKV].mkv", (1, None), preset=[PresetWEB, PresetEAC3])
WEB_AMZ = FileInfo('Episodes/Amazon/Tantei wa Mou, Shindeiru. - 05 (Amazon dAnime CBR 720p).mkv', (None, -1), preset=[PresetWEB, PresetEAC3])
...
def main() -> vs.VideoNode:
    ...
    src_bl = src_bl[:8747] + src_bl[8747] * 2 + src_bl[8748:]
    src_fu = src_fu[:6186] + src_bl[6186:6388] + src_fu[6388:]
...
# Graining
    ...
    # scomp = lvf.comparison.stack_compare(dehardsubed, src_bl)
    return final
