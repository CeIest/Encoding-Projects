...
JPBD = FileInfo(BDMV_PATH / r'00012.m2ts', (24, -24), preset=[PresetBD, PresetAAC])
...
def main() -> vs.VideoNode:
    ...
    src = hvf.SMDegrain(src, tr=0.5, thSAD=150)
    ...
    grain = vdf.noise.Graigasm(**graigasm_args).graining(src)
