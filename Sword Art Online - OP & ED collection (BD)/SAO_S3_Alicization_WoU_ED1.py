...
#Source
JPBD = FileInfo(r'm2ts/SAO_S3_Alicization_WoU_ED1.m2ts', 24, -24,
...
def main() -> vs.VideoNode:
    ...
    crop = core.std.Crop(extragrain, 0, 0, 132, 132).edgefixer.ContinuityFixer(0, 1, 0, 0)
    crop = core.std.AddBorders(crop, 0, 0, 132, 132)
    cropout = lvf.misc.replace_ranges(extragrain, crop, [(0, 137), (309, 439), (1958, 2119)])
