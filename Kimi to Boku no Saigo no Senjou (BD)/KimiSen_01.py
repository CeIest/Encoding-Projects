...
#16 = 1, 17 = 2, 18 = 3, 19 = 4
JPBD = FileInfo(BDMV_PATH / r'00016.m2ts', (None, -25), preset=[PresetBD, PresetAAC])
...
def main() -> vs.VideoNode:
    ...
    scaled = remap_rfs(scaled, src, [(0, 1205)])
    out = scaled
    ...
    deband_custom = dumb3kdb(out, threshold=[45, 34, 26], grain=2)
    deband_custom = remap_rfs(deband, deband_custom, [(0, 105)])
    deband = core.std.MaskedMerge(deband_custom, out, deband_mask.resize.Point(format=vs.GRAY16))
    out = deband
